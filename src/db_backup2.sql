...
CREATE TABLE `apsds` (
  ...
  `eng_test_res` int(11) DEFAULT NULL,
  `crc` varchar(50) DEFAULT NULL,
  `medical_note` varchar(20) DEFAULT NULL,
  `interview` date DEFAULT NULL,
  `approved` tinyint(1) DEFAULT NULL,
  `diploma_and_trans` varchar(50) DEFAULT NULL,
...
CREATE TABLE `graduations` (
  `student_id` int(11) DEFAULT NULL,
  `tuition_paid` tinyint(1) DEFAULT NULL,
  `transcript` tinyint(1) DEFAULT NULL,
  `completion_letter` tinyint(1) DEFAULT NULL,
  `signed_diploma` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `ppes` (
  ...
  `first_aid_loc` varchar(100) DEFAULT NULL,
  `first_aid_contact` varchar(50) DEFAULT NULL,
  `order_date` date DEFAULT NULL,
  `pickup_date` date DEFAULT NULL,
  `first_aid_and_cpr` datetime DEFAULT NULL,
  `cert_mark_received` date DEFAULT NULL,
