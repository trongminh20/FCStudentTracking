            ...
            <form class="col-lg-8" action="?action=c_add_ppes" method="POST">
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <div id="AcknowledgementAndAgreementSigned" class="row" style="padding-top: 10px">
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="ack_and_agr" id="AcknowledgementAndAgreementSigned" value="yes"
                                       type="radio"/>
                                YES</label>
                        </div>
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="ack_and_agr" id="AcknowledgementAndAgreementSigned" value="no"
                                       type="radio"/>
                                NO</label>
                        </div>
                    </div>
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <div name="acknowledgement_And_Medical_File_Received" id="AcknowledgementAndMedicalFileReceived"
                         class="row" style="padding-top: 10px">
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="medical_file" id="AcknowledgementAndMedicalFileReceived" value="yes"
                                       type="radio"/>
                                YES</label>
                        </div>
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="medical_file" id="AcknowledgementAndMedicalFileReceived" value="no"
                                       type="radio"/>
                                NO</label>
                        </div>
                    </div>
