        ...
        <div class="col-xs-12">
            ...
            <form class="col-lg-8" action="?action=c_add_ppes" method="POST">
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <input type="date" class="form-control" name="order_date" id="ShirtOrderDate"
                           name="shirt_Order_Date"/>
                </div>
                <!--pick up date-->
                <div class="form-group" style="padding-top: 20px">
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <input type="datetime-local" class="form-control" id="FirstAidandCPRDateandTime"
                           name="fa_and_cpr_dt"/>
                </div>
                <!--first aid & cpr location & contact -->
                <div class="form-group" style="padding-top: 20px">
                    <label for="FirstAidandCPRLocandContact">First Aid & CPR Location & Contact: </label>
                    <textarea type="text" class="form-control" id="FirstAidandCPRLocandContact"
                              name="fa_and_cpr_contact"
                              rows="3"></textarea>
                </div>
                <!--certificate of first aid & cpr received date-->
                <div class="form-group" style="padding-top: 20px">
                    <label for="FirstAidandCPRCertificateReceiveDate">Certificate of First Aid & CPR Receive
                        Date:</label>
                    <input type="date" class="form-control" id="FirstAidandCPRCertificateReceiveDate"
                           name="cert_fa_cpr_receive"/>
                </div>
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <input type="date" class="form-control" id="foodsafeCertificateReceiveDate"
                           name="cert_foodsafe_receive"/>
                </div>
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <div class="form-group" style="padding-top: 20px">
                        <label class="control-label" for="ClinicHankbookReceiveDate">Clinic Hankbook Receive
                            Date:</label>
                        <input type="date" class="form-control" id="ClinicHankbookReceiveDate"
                               name="cli_handbook_receive"/>
                    </div>
                    ...
                    <div class="form-group" style="padding-top: 20px">
                        ...
                        <div id="ClinicAckAndAgrFormSigned" class="row" style="padding-top: 10px">
                            <div class="col-sm-6">
                                <label class="radio-inline">
                                    <input name="cli_ack_and_agr" id="ClinicAckAndAgrFormSigned" value="yes"
                                           type="radio"/>
                                    YES</label>
                            </div>
                            <div class="col-sm-6">
                                <label class="radio-inline">
                                    <input name="cli_ack_and_agr" id="ClinicAckAndAgrFormSigned" value="no"
                                           type="radio"/>
                                    NO</label>
                            </div>
                        </div>
                    ...
                    <div class="form-group" style="padding-top: 20px">
                        ...
                        <div name="Medical_File_Received" id="MedicalFileReceived" class="row"
