        ...
        <div class="col-xs-12">
          ...
          <div class="form-group" style="padding-top: 20px">
                ...
                <div class="form-group" style="padding-top: 20px"> 
            		...
            		<input type="number" class="form-control" id="applicationFee" name="app_fee" placeholder="$"/>
          		</div>
                ...
                <div class="form-group" style="padding-top: 20px"> 
          		...
          		<div id="rmtOnlyIntroPay" class="form-group" style="padding-top: 20px; display: none;"> 
            		...
            		<input type="number" class="form-control" id="introToMassageFee" name="intro_msg_fee" placeholder="$"/>
          		</div>
          		<!--course materials fee-->
          		<div class="form-group" style="padding-top: 20px"> 
            		<label class="control-label" for="courseMaterialsFee">Course Materials Fee:</label>
            		<input type="number" class="form-control" id="courseMaterialsFee" name="materials_fee" placeholder="$"/>
          		</div>
          		<!--textbook fee-->
          		<div class="form-group" style="padding-top: 20px"> 
