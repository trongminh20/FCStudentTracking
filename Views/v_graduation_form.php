            ...
            <form class="col-lg-8" action="?action=c_add_grad" method="POST">
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <div id="officialTranscript" class="row" style="padding-top: 10px">
                        ...
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="official_transcript" id="officialTranscript" value="no" type="radio"/>
                                NO</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <div name="official_Completion_Letter" id="officialCompletionLetter" class="row"
                         style="padding-top: 10px">
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="completion_letter" id="officialCompletionLetter" value="yes" type="radio"/>
                                YES</label>
                        </div>
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="completion_letter" id="officialCompletionLetter" value="no" type="radio"/>
                                NO</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <div name="copy_Of_Signed_Diploma" id="copyOfSignedDiploma" class="row" style="padding-top: 10px">
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="signed_diploma" id="copyOfSignedDiploma" value="yes" type="radio"/>
                                YES</label>
                        </div>
                        <div class="col-sm-6">
                            <label class="radio-inline">
                                <input name="signed_diploma" id="copyOfSignedDiploma" value="no" type="radio"/>
                                NO</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group" style="padding-top: 20px">
                    ...
                    <textarea type="text" class="form-control" name="employment" id="employmentFollowUp"
                              rows="5"></textarea>
                </div>
                <!--submit button-->
