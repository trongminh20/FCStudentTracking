...
<div id="main-container">
    ...
    <div class="content" id="item2">
        ...
        <br>        
        <p><img src="search.png" alt="search_box"></p>       
        <br>    
        ...
        <br><br>
        <p> 3. Press Enter  <img src="enter.jpg" alt="enter" style="width:80px;height:40px;"> or search tab button <img src="search_button.jpg" style="width:80px;height:40px;"></p> 
        <br>
    </div>
