...
<div id="mainContainer">
    ...
    <div class="content" id="generateInvoice">
        ...
        <ul>
            <li><strong> Invoice Number: </strong> An autogenerated number </li>
    ...
    <div class="content" id="generateReport">
        ...
        <ul>
            <li><strong> Preview: </strong> Generates a pdf preview of the report in a new tab</li>
            <li><strong> Generate: </strong> Generates and downloads a pdf copy of the report </li>
        </ul>
