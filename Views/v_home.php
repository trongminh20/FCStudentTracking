                ...
                <div class="card mt-3">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h7 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="15" viewBox="0 -1 29 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-globe mr-2 icon-inline"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>Website</h7>
                            <span class="text-secondary" style="float: right">https://firstcollege.ca</span>
                        </li>
                        <!--college ins-->
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            <h7 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="15" viewBox="0 -1 29 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-instagram mr-2 icon-inline text-danger"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>Instagram</h7>
                ...
                <div class="card mb-3">
                    ...
                    <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary" style="padding-top: 7px"><?=$_SESSION['user']['phone']?></div>
                        </div>
                    <hr>
                        <!--department-->
                        <div class="row">
                            ...
                            <div class="col-sm-9 text-secondary" style="padding-top: 7px"><?=$_SESSION['user']['department']?></div>
                        </div>
                    </div>
                </div>
