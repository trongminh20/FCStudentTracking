...
<form id="form1" name="form1" method="post" action="mass_admission.php">
    ...
    <br class="clear"/>
    <label for="eng_test">English test Result(for non-English Speaker)</label><input type="text" name="eng_test"
                                                                                     id="eng_test"/>
    <br class="clear"/>
    ...
    <br class="clear"/>
    <label for="acknowledgement">Acknowledgement and Agreement Form</label><input type="text" name="acknowledgement"
                                                                                  id="acknowledgement"/>
    <br class="clear"/>
